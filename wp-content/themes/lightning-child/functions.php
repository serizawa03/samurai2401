 ...
 */
 ...
 function add_link_files() {
  ...
  // CSSの読み込み
  wp_enqueue_style( 'vegas', get_stylesheet_directory_uri().'/css/vegas.min.css' );
  // JavaScriptの読み込み
  wp_enqueue_script( 'vegas-js', get_stylesheet_directory_uri().'/js/vegas.min.js', array('jquery'), false, true );
}
